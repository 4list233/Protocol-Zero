...
KNACK_APPLICATION_ID=your_application_id_here
KNACK_REST_API_KEY=your_rest_api_key_here
```
...
2. Test API connection:
   ...
   curl -X GET "https://api.knack.com/v1/objects/YOUR_OBJECT_KEY/records" \
     -H "X-Knack-Application-Id: your_application_id_here" \
     -H "X-Knack-REST-API-Key: your_rest_api_key_here"
   ```
